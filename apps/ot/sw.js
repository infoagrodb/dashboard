const CACHE_NAME = 'ordenes-trabajo-v1'; // subir este número obliga a refrescar el caché entero
const APP_SHELL = [
  './OrdenesDeTrabajo.html',
  './manifest.json'
];
...
// en vez de quedar "una versión atrás" como pasaba con cache-first. Mismo criterio que
// recuentosEf.html.
